...
def sensor():
    ...
    try:
        ...
        while True:
            ...
            temperature_data = f'TEMPERATURE: {temperature_value:.2f}, Time: {formatted_timestamp}'
            ...
            if humidity_value > 80:
                formatted_timestamp = datetime.fromtimestamp(timestamp).strftime('%Y-%m-%d %H:%M:%S')
                humidity_data = f'HUMIDITY: {humidity_value:.2f}, Time: {formatted_timestamp}'
